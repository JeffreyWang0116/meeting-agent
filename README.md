...
- **錯字校正一律不動人名與稱謂**：實測交通部預算協商，逐字稿把「陳清龍」聽成「曾清農」，校正每跑一次就換成不同的立委（陳菁徽、曾玟培、陳素月、林楚茵），詞彙表是空的也照編；使用者回報「陳總召」被改成詞彙表裡的「陳澤安」是同一類。提示已講明，本地再擋四種：模型自報 `type` 是人名／稱謂、理由提到人名或立委、稱謂在修正前後不一致（「陳總召」→「陳澤安」、「原長」→「主席」）、改成或改掉詞彙表裡註明人名的詞。人名錯了用歷史會議的「詞彙統一替換」手動改。
...
tests/                    # pytest 測試（873，全部離線、不需金鑰；前端講者判斷另需 node）
