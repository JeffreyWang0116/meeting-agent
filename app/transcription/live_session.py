...
class LiveSessionManager:
    def __init__(self, transcriber, work_dir: Path | str):
    ...
    def start(self) -> str:
        ...
        with self._lock:
            self._sessions[session_id] = LiveSession(id=session_id, dir=session_dir)
        return session_id
    ...
    def add_chunk(self, session_id: str, data: bytes, suffix: str = ".webm") -> dict:
        ...
        return {"text": text, "transcript": self.transcript(session_id)}
